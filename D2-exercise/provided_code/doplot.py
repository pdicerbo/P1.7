...
# plt.title('Speedup for DSYEV for matrix size = 8000 (ULISSE)')
# plt.title('Speedup for DSYEV for matrix size = 4000 (ULISSE)')
plt.title('Speedup for DSYEV for matrix size = 10000 (ULISSE)')
plt.xlabel('# Threads')
plt.ylabel('Speedup')
